 ...
 *    - v212/213 added
 *    - v216 added a connection to _log.gsc
 *    - Description correction to cod 1.5 and script additions
 *    
 *    
***/
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// CoD 1.5 Menu
//1	precacheMenu(game["menu_serverinfo"]);
//1	precacheMenu(game["menu_team"]);
//1	precacheMenu(game["menu_weapon_allies"]);
//1	precacheMenu(game["menu_weapon_axis"]);
//1	precacheMenu(game["menu_viewmap"]);
//1	precacheMenu(game["menu_callvote"]);
//1	precacheMenu(game["menu_quickcommands"]);
//1	precacheMenu(game["menu_quickstatements"]);
//1	precacheMenu(game["menu_quickresponses"]);

//15	maps\mp\gametypes\_teams::precache();
//15	maps\mp\gametypes\_teams::scoreboard();
		
//2	precacheShader("objpoint_star");
//2	precacheString(&"SD_MATCHSTARTING");
//2	precacheString(&"SD_MATCHRESUMING");
//2	precacheString(&"SD_EXPLOSIVESPLANTED");
//2	//Bomb Plant Announcement
...
//	precacheString(&"SD_ALLIESHAVEBEENELIMINATED");
//	precacheString(&"SD_AXISHAVEBEENELIMINATED");
//2	//precacheString(&"PLATFORM_HOLD_TO_PLANT_EXPLOSIVES");
//2	//precacheString(&"PLATFORM_HOLD_TO_DEFUSE_EXPLOSIVES");
...
onStartGameType()
{
	...
	logprint("sd::onStartGameType found " + spawnpoints.size + " spawnpoints\n");
	
	for(i = 0; i < spawnpoints.size; i++)
		spawnpoints[i] PlaceSpawnpoint();
//following will crash the server
/*	logprint("sd::onStartGameType: find bombzones.\n");
	bombzones = getentarray("bombzone", "targetname");
		
	if(!bombzones.size)
	{
    		logprint("sd::onStartGameType: 0 bombzones found. AbortLevel.\n");
    		maps\mp\gametypes\global\_global::AbortLevel();
    		return;
	}

	for(i = 0; i < bombzones.size; i++)
		bombzones[i] PlaceSpawnpoint();
*/
...
//v20 was activated
	...
	// LOG stuff
//v216	level notify("log_round_end", roundwinner);
